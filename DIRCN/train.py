...
from dircn.models.losses import GaussianSSIMLoss, SSIMLoss, MSSSIMLoss
...
# loss = [(1.0, SSIMLoss()), (1.0, torch.nn.L1Loss())]
# loss = [(1.0, SSIMLoss()), (1.0, torch.nn.L1Loss())]
# loss = [(1.0, SSIMLoss())]
...
trainer.resume_checkpoint(
    resume_model="/root/fastMRI/DIRCN/version3/pretrained/checkpoint.pth",
    resume_metric="/root/fastMRI/DIRCN/version3/pretrained/statistics.json"
)
